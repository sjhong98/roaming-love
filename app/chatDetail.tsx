    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            >
                ...
                <ScrollView
                    style={{ flex: 1, backgroundColor: '#FFEBEB', width: '100%' }}
                    contentContainerStyle={{ width: '100%', paddingBottom: 50, paddingTop: 20, paddingHorizontal: 21, minHeight: Dimensions.get('window').height - 100, gap: 14 }}
