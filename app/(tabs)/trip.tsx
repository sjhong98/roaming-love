                        ...
                        <View style={{ width: '100%', paddingHorizontal: 24, position: 'relative', marginTop: -10 }}>
                            <View style={{ boxShadow: "0px 5px 9.1px rgba(219, 79, 79, 0.1)", width: '100%', paddingHorizontal: 21, paddingVertical: 27, borderRadius: 20 }}>
                                ...
                                <View style={{ flexDirection: 'row', gap: 10, marginTop: 20 }}>
                                    <TouchableOpacity onPress={() => setSelectedForm({ ...selectedForm, period: 'weekend' })} style={{ width: '30%', justifyContent: 'center', alignItems: 'center', paddingVertical: 13, borderRadius: 15, borderWidth: selectedForm.period === 'weekend' ? 1.5 : 1, borderColor: selectedForm.period === 'weekend' ? '#444' : '#bebebe', backgroundColor: selectedForm.period === 'weekend' ? '#d9d9d9' : '#fff' }}><Text>일주일</Text></TouchableOpacity>
